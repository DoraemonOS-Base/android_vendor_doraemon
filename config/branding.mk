...
DORAEMON_PLATFORM_VERSION := 10.DORAEMON

TARGET_PRODUCT_SHORT := $(subst doraemon_,,$(DORAEMON_BUILD))

DORAEMON_VERSION := DoraemonOS_$(DORAEMON_BUILD)-$(DORAEMON_PLATFORM_VERSION)-$(DORAEMON_BUILD_DATE)-$(DORAEMON_BUILD_TYPE)
DORAEMON_VERSION_PROP := 10
ROM_FINGERPRINT := DoraemonOS/$(DORAEMON_PLATFORM_VERSION)/$(TARGET_PRODUCT_SHORT)/$(DORAEMON_BUILD_DATE)
